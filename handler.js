...
global.dfail = (type, m, conn) => {
    const msg = {
        rowner: `🚩 Hola, este comando solo puede ser utilizado por *IV-BOT*.`,
        owner: `👤 Usuario, Este Comando Solo Puede Ser Utilizado Por *IV-BOT*.`,
        mods: `🤚🏻 Hola, este comando solo puede ser utilizado por *IV-BOT*.`,
